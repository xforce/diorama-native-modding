...
#undef max
    ...
    public:
        ...
        basic_vector2 operator-(const T right) const
        {
            return basic_vector2{ this->_x - right, this->_y - right };
        }
        ...
        bool operator>(const basic_vector2 &other)  const
        {
        ...
        basic_vector2 normalized() const
        {
            return this->operator/(this->magnitude());
        }

        T dot(const basic_vector2& otr)
        {
            return this->_x * otr._x + this->_y * otr._y;
        }

        T angle(const basic_vector2& to)
        {
            return angle(*this, to);
        }

        static T angle(const basic_vector2& from, const basic_vector2& to)
        {
            return 0.0f;
        }

        basic_vector2 lerp(const basic_vector2& to, float t)
        {
            return lerp(*this, to, t);
        }

        static basic_vector2 lerp(basic_vector2 from, basic_vector2 to, float t)
        {
            return (from + t * (to - from));
        }

        basic_vector2 slerp(const basic_vector2& to, float t)
        {
        ...
        basic_vector2 nlerp(const basic_vector2& to, float t)
        {
    ...
    public:
        ...
        basic_vector3 operator-(const basic_vector3 &other) const
        {
            return basic_vector3{ this->_x - other._x, this->_y - other._y, this->_z - other._z };
        }

        basic_vector3 operator-(const T other) const
        {
            return basic_vector3{ this->_x - other, this->_y - other, this->_z - other };
        }
        ...
        basic_vector3 operator%(T other) const
        {
            return basic_vector3{ fmodf(this->_x, other),  fmodf(this->_y, other),  fmodf(this->_z, other) };
        }
        ...
        basic_vector3 normalized() const
        {
            return this->operator/(this->magnitude());
        }

        T dot(const basic_vector3& otr)
        {
            return this->_x * otr._x + this->_y * otr._y + this->_z * otr._z;
        }

        T angle(const basic_vector3& to)
        {
            return angle(*this, to);
        }

        static T angle(const basic_vector3& from, const basic_vector3& to)
        {
            return 0.0f;
        }

        // Or should we assign it to self?
        basic_vector3 lerp(const basic_vector3& to, float t)
        {
            return lerp(*this, to, t);
        }
        ...
        basic_vector3 slerp(const basic_vector3& to, float t)
        {
            return slerp(*this, to, t);
        }
        ...
        basic_vector3 nlerp(const basic_vector3& to, float t)
        {
            return nlerp(*this, to, t);
        }
    ...
    inline Vector3f RadianToRotation(Vector3f r)
    {
    ...
    inline Vector3f RotationToRadian(Vector3f r)
    {
